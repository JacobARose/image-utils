...
conda create -n $ENV_NAME python>=3.8 mamba
conda activate $ENV_NAME
mamba install pytorch=1.11.0 torchvision=0.12 cudatoolkit=10.2 cupy opencv pkg-config numba compilers libjpeg-turbo nodejs libgcc-ng libgcc llvmdev -c fastchan -c pytorch -c conda-forge
